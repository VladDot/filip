...
export const getStyles = ({ isOpen }: IGetStyles) => ({
  header:
    'flex justify-between items-center border relative z-[6] border-blueBorder/20 rounded-lg p-2 md:p-4 cursor-pointer bg-white shadow-md transition-all duration-300 relative z-[4]',
