  ...
  return (
    <>
      <section className="relative z-[2] flex h-[650px] w-full items-center justify-center overflow-hidden md:h-[808px]">
        <div className="bgg absolute inset-0 z-[2]" />
      ...
      <div className="relative z-[1] bg-white">
        <div className="absolute top-1/2 left-1/2 h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 bg-blue-500"></div>
        <div className="relative z-[1] mix-blend-plus-lighter">
          <video
            loop
            muted
            autoPlay
            ...
            src="/grid.mp4"
            poster="/gridWebP.webp"
            className="pointer-events-none z-[999] h-[622px] w-full object-cover select-none md:h-[808px]"
          />
        </div>
      </div>
    </>
